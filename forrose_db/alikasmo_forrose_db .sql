...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2017 at 04:27 PM
...
UPDATE `tbl_siparisdetay` SET `siparisDetayid` = 5,`siparisid` = 1,`itemid` = 9,`miktar` = 20,`unit_id` = 1 WHERE `tbl_siparisdetay`.`siparisDetayid` = 5;
...
UPDATE `tbl_siparislerimiz` SET `siparisid` = 1,`siparisKodu` = 'ali123',`siparisTarihi` = '2017-06-20',`teslimTarihi` = '2017-06-25',`siparis_durumu` = 1,`saticiid` = 1,`iletisimid` = 2,`sat_adresid` = 4,`aliciid` = 1,`aliciadres` = 1,`aliciiletisim` = 1,`tutar` = 5526.5,`ihracatMaliyeti` = 2000.50,`vergi` = 300.2,`Toplam` = 7827.2,`doviz_id` = 2,`odemePlaniid` = 4,`odemeDurumu` = 1,`odemeYapan` = 1 WHERE `tbl_siparislerimiz`.`siparisid` = 1;

-- --------------------------------------------------------

--
-- Table structure for table `tbl_siparisnote`
--

CREATE TABLE `tbl_siparisnote` (
  `siparisnoteid` int(11) NOT NULL,
  `siparisid` int(11) DEFAULT NULL,
  `note` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbl_siparisnote`
--

UPDATE `tbl_siparisnote` SET `siparisnoteid` = 1,`siparisid` = 1,`note` = 'paid to abu emir by us in 05/12/2017 document no : 521468 kuvyt turk' WHERE `tbl_siparisnote`.`siparisnoteid` = 1;
UPDATE `tbl_siparisnote` SET `siparisnoteid` = 2,`siparisid` = 1,`note` = 'paid to abu ali 12/03/2018' WHERE `tbl_siparisnote`.`siparisnoteid` = 2;
...
--
-- Indexes for table `tbl_siparisnote`
--
ALTER TABLE `tbl_siparisnote`
  ADD PRIMARY KEY (`siparisnoteid`),
  ADD KEY `siparisidfk` (`siparisid`);
...
--
ALTER TABLE `tbl_siparisdetay`
  MODIFY `siparisDetayid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT for table `tbl_siparisnote`
--
ALTER TABLE `tbl_siparisnote`
  MODIFY `siparisnoteid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
-- Constraints for table `tbl_siparisnote`
--
ALTER TABLE `tbl_siparisnote`
  ADD CONSTRAINT `siparisidfk` FOREIGN KEY (`siparisid`) REFERENCES `tbl_siparislerimiz` (`siparisid`) ON DELETE SET NULL ON UPDATE CASCADE;
